...
Οι κατηγορίες που υπάρχουν είναι οι εξής:
 ...
 - **Cache**: Functions ενός (υπό ανάπτυξη και έλεγχο ακόμη) δοκιμαστικού συστήματος caching που έχει ως σκοπό την βελτιστοποίηση της απόδοσης σε περιπτώσεις που υπάρχουν στην αποστολή πολλές ΑΙ μονάδες (και groups).
