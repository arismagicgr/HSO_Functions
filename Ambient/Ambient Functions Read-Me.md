...
Αυτή η _default_ τιμή, ψάχνει
να βρει μία `mission parameter` με _className_ `"disableLightsRadius"` και να πάρει την τιμή που έχει
οριστεί εκεί. Σε περίπτωση που δεν υπάρχει αυτή η παράμετρος, τότε η _default_ τιμή γίνεται **1000** μέτρα.
...
Σε περίπτωση που δεν οριστεί κάτι (όπως και η default κατάσταση του function) το `_obj` θα χρησιμοποιηθεί ως επίκεντρο.
...
Τέλος, υπάρχει επιλογή (η 2η παράμετρος), αυτό το function να θέτει το damage του `_obj` σε **1** (`1_target setDamage 1`) (το καταστρέφει δηλαδή)
